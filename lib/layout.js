...
(function(root, factory) {
  ...
  (function() {
    mask.registerHandler('l:center', {renderStart: function() {
        this.nodes = createNode('display: table; min-height: 100%; width: 100%; overflow: auto', createNode('display: table-cell; vertical-align: middle', createNode('margin: 0 auto', this.nodes, this.attr)));
      }});
